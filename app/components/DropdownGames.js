...
import { Alert, Picker, StyleSheet, TextInput, View } from 'react-native';
    ...
    <View style = {styles.container}>
      <View style = {styles.boxes}>
        <View style = {{alignItems: 'center'}}>
          ...
          style={styles.picker}
          onValueChange={(item) => {handleSubmitGame(item);
          }}
          >
        ...
        {Array.from({length: numberOfPlayers}, (_, i) => i + 1).map((item, key) => (
          <View key={key} style={styles.placements}>
            <View style={styles.placements_choices}>
              <Picker
              onValueChange={(a) => handleSubmitPlayer(a, key)}
              >
